...
export default function DraggableTreeNode(props) {
    const { node, rowHeight, draggingNodeId, onDragStart, onDrag, onDragEnd } = props;
    ...
    const nodePlaceholder = <div style={{ backgroundColor: 'gray', height: rowHeight - 2, marginTop: 2, width: 100 }} />;
